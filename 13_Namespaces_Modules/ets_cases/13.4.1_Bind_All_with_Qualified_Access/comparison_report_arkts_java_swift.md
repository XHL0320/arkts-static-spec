...
**WSL实测验证：** ✅ 已在 WSL Ubuntu (Java OpenJDK 1.8.0_492 + Swift 6.0.3) 中真实编译运行验证
...
| Java | JLS SE21 §7.5 Import Declarations | OpenJDK 1.8.0_492 (WSL) — 实测 `import nsm141.*; BindAllTarget.VALUE_A=1, VALUE_B=2` ✅ |
