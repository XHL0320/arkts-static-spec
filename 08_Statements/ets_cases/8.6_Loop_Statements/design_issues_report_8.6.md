...
**总体结论：** 除 STM-I2（编译器未实现 spec 要求的 label-not-used 检查）外，8.6 章节所有循环语句行为均与 ArkTS 规范一致，未发现其他设计问题。循环语句设计整体成熟，与 Java/Swift 在核心语义上高度对齐。
