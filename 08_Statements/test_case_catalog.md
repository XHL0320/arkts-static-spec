...
| STM_08_15_006_PASS_try_in_if_statement | compile-pass | 验证 try-catch 语句可以放在 if 语句体内，与其他控制流结构组合 |
...
| STM_08_05_011_PASS_char_condition_extended | compile-pass | char 类型作为 if 条件 — Extended Conditional Expressions 允许 char（c'\u0000' → false，其他  |
