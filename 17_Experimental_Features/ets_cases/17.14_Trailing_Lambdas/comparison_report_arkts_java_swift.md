...
| 不支持带参数 trailing lambda | N/A | 支持 `f { x in ... }` | Swift 更强大 |
| 不支持多个 trailing lambda | N/A | 支持 (Swift 5.3+) | Swift 更强大 |
...
| # | 用例 | ArkTS | Java | Swift |
|---|------|-------|------|-------|
| 001 | 简单 trailing lambda | ✅ compile-pass | ❌ 无此语法 | ✅ (trailing closure) |
