...
4. **native + regular constructor 共存是强大的设计**：
...
1. **保持 native constructor 作为差异化特性**：这是 ArkTS 相对于 Java 和 Swift 的独特优势。在需要平台原生构造对象的场景（如 NAPI 构造、底层系统对象初始化）中，native constructor 提供了最直接的语义表达。
