...
| # | 用例 ID | 语法点 |
|---|---------|------|
| 6 | `ITF_10_01_006_FAIL_INTERFACE_INSTANTIATION` | 接口不能 new |

### runtime (1)
| # | 用例 ID | 语法点 |
|---|---------|------|
| 7 | `ITF_10_01_007_RUNTIME_INTERFACE_POLYMORPHISM` | 接口多态运行时 |
...
| # | 用例 ID | 语法点 |
|---|---------|------|
| 11 | `ITF_10_02_004_FAIL_EXTENDS_NON_INTERFACE` | extends 非接口 |
| 12 | `ITF_10_02_005_FAIL_EXTENDS_CYCLE` | 循环继承 |
| 13 | `ITF_10_02_006_FAIL_SELF_EXTENDS` | 自继承 |
| 14 | `ITF_10_02_007_FAIL_BAD_TYPE_ARGS` | 错误类型参数 |

### runtime (1)
| # | 用例 ID | 语法点 |
|---|---------|------|
| 15 | `ITF_10_02_008_RUNTIME_MULTI_LEVEL_EXTENDS` | 多层继承运行时调用 |
...
| # | 用例 ID | 语法点 |
|---|---------|------|
| 19 | `ITF_10_03_004_FAIL_DUPLICATE_MEMBER` | 重复成员 |
| 20 | `ITF_10_03_005_FAIL_OBJECT_METHOD_CLASH_RETURN_GAP` | ❌ Object 返回值冲突 (ISS-10-02 — 编译器未拒绝) |

### runtime (1)
| # | 用例 ID | 语法点 |
|---|---------|------|
| 21 | `ITF_10_03_006_RUNTIME_METHOD_MEMBER` | 接口方法成员运行时调用 |
...
| # | 用例 ID | 语法点 |
|---|---------|------|
| 23 | `ITF_10_04_002_FAIL_GETTER_ONLY_ASSIGN` | getter-only 赋值 |
| 24 | `ITF_10_04_003_FAIL_SETTER_ONLY_READ` | setter-only 读取 |

### runtime (1)
| # | 用例 ID | 语法点 |
|---|---------|------|
| 25 | `ITF_10_04_004_RUNTIME_INTERFACE_PROPERTY` | 接口属性运行时 |
...
| # | 用例 ID | 语法点 |
|---|---------|------|
| 32 | `ITF_10_04_01_007_FAIL_REQUIRED_NOT_IMPLEMENTED` | 必需属性未实现 |

### runtime (1)
| # | 用例 ID | 语法点 |
|---|---------|------|
| 32 | `ITF_10_04_01_008_RUNTIME_REQUIRED_PROPERTY` | 必需属性运行时 |
...
| # | 用例 ID | 语法点 |
|---|---------|------|
| 36 | `ITF_10_04_02_004_FAIL_OPTIONAL_NOT_ASSIGNED` | 可选属性未赋值 |

### runtime (2)
| # | 用例 ID | 语法点 |
|---|---------|------|
| 37 | `ITF_10_04_02_005_RUNTIME_OPTIONAL_PROPERTY` | 可选属性运行时 |
| 38 | `ITF_10_04_02_006_RUNTIME_OPTIONAL_PROPERTY_DEFAULT_SETTER` | 可选属性默认 setter（规范 §10.4.2） |
...
| # | 用例 ID | 语法点 |
|---|---------|------|
| 45 | `ITF_10_05_007_FAIL_MISSING_IMPLEMENTATION` | 缺失实现 |
| 46 | `ITF_10_05_008_FAIL_METHOD_SIGNATURE_MISMATCH` | 方法签名不匹配 |

### runtime (2)
| # | 用例 ID | 语法点 |
|---|---------|------|
| 47 | `ITF_10_05_009_RUNTIME_INTERFACE_IMPL` | 接口实现运行时 |
| 48 | `ITF_10_05_010_RUNTIME_INTERFACE_PROPERTY` | 接口属性运行时 |
...
| # | 用例 ID | 语法点 |
|---|---------|------|
| 54 | `ITF_10_06_006_FAIL_INHERITED_GETTER_ONLY_WRITE` | 继承 getter-only 写 |
| 55 | `ITF_10_06_007_FAIL_INHERITED_SETTER_ONLY_READ` | 继承 setter-only 读 |
| 56 | `ITF_10_06_008_FAIL_MULTI_INHERIT_SETTER_ONLY_READ` | 多继承 setter-only 读 |
| 57 | `ITF_10_06_009_FAIL_MULTI_INHERIT_GETTER_ONLY_WRITE` | 多继承 getter-only 写 |

### runtime (1)
| # | 用例 ID | 语法点 |
|---|---------|------|
| 58 | `ITF_10_06_010_RUNTIME_INHERITANCE_CHAIN` | 继承链运行时方法解析 |
