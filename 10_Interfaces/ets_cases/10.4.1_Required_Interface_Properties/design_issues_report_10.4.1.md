...
| 行为 | 用例 | 状态 |
|------|------|------|
| 必需读写属性 `prop: T` | ITF_10_04_101 | ✅ |
| 必需只读属性 `readonly ro: T` | ITF_10_04_102 | ✅ |
| getter 声明 `get val(): T` | ITF_10_04_103 | ✅ |
| setter 声明 `set val(v: T): void` | ITF_10_04_104 | ✅ |
| getter-only 声明 | ITF_10_04_105 | ✅ |
| setter-only 声明 | ITF_10_04_106 | ✅ |
| 字段可满足访问器声明 | ITF_10_04_107 | ✅ |
| 必需未实现编译拒绝 | ITF_10_04_108 | ✅ |
