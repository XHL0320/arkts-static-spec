// Swift Runtime Test - 对应 2.9.9 Null Literal (补充用例)
...
@main
struct NullLiteralNewRuntimeTest {
    static func main() {
        print("=== Swift Null Literal New Runtime Test ===")
        ...
        print("")
        print("=== Swift Null Literal New Runtime Test PASSED ===")
