...
经 es2panda + ark VM 实测，以下行为与 ArkTS spec §7.36.1 一致：

| 行为 | 验证方式 | 结果 |
|------|---------|------|
| 常量表达式求值细节：字符串拼接编译期完成，数值运算编译期完成，+0与-0视为相等，NaN与任何值不相等 | 10 compile-pass + 10 compile-fail + 10 runtime | ✅ 全部通过 |
...
| Spec 一致性 | ✅ 与 arktsspecification.md §7.36.1 一致 | ✅ JLS SE21 | ✅ Swift 5.10 | N/A |
