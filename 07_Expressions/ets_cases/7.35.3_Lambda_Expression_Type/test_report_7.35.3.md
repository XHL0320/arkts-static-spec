...
| # | 用例 ID | 测试内容 | 结果 |
|---|---------|---------|------|
| | EXP_07_35_03_001_PASS_LAMBDA_TYPE_FUNC | Lambda 类型为函数类型 | ✅ 通过 |
| | EXP_07_35_03_002_PASS_LAMBDA_RETURN_INFERRED | Lambda 返回类型从体推断 | ✅ 通过 |
...
| # | 用例 ID | 验证内容 | 结果 |
|---|---------|---------|------|
| | EXP_07_35_03_003_RUNTIME_LAMBDA_TYPE_CHECK | Lambda 类型为函数类型运行时验证 | ✅ 通过 |
