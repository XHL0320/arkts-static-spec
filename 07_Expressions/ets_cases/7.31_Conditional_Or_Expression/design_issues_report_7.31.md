...
经 es2panda + ark VM 实测，以下行为与 ArkTS spec §7.31 一致：

| 行为 | 验证方式 | 结果 |
|------|---------|------|
| 条件或表达式（||），左结合，短路求值，仅在左操作数为false时求值右操作数 | 10 compile-pass + 10 compile-fail + 10 runtime | ✅ 全部通过 |
...
| Spec 一致性 | ✅ 与 arktsspecification.md §7.31 一致 | ✅ JLS SE21 | ✅ Swift 5.10 | N/A |
