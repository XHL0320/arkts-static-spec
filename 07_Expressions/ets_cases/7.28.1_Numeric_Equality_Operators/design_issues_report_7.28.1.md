...
经 es2panda + ark VM 实测，以下行为与 ArkTS spec §7.28.1 一致：

| 行为 | 验证方式 | 结果 |
|------|---------|------|
| 数值相等运算符，byte/short/int/long/float/double/char间比较数值 | 10 compile-pass + 10 compile-fail + 10 runtime | ✅ 全部通过 |
...
| Spec 一致性 | ✅ 与 arktsspecification.md §7.28.1 一致 | ✅ JLS SE21 | ✅ Swift 5.10 | N/A |
