...
经 es2panda + ark VM 实测，以下行为与 ArkTS spec §7.29.1 一致：

| 行为 | 验证方式 | 结果 |
|------|---------|------|
| 整数位运算符（& | ^ ~），操作数为byte/short/int/long及对应bigint | 10 compile-pass + 10 compile-fail + 10 runtime | ✅ 全部通过 |
...
| Spec 一致性 | ✅ 与 arktsspecification.md §7.29.1 一致 | ✅ JLS SE21 | ✅ Swift 5.10 | N/A |
