...
经 es2panda + ark VM 实测，以下行为与 ArkTS spec §7.35.1 一致：

| 行为 | 验证方式 | 结果 |
|------|---------|------|
| Lambda签名，参数类型可标注或推导，返回类型由body推导 | 10 compile-pass + 10 compile-fail + 10 runtime | ✅ 全部通过 |
...
| Spec 一致性 | ✅ 与 arktsspecification.md §7.35.1 一致 | ✅ JLS SE21 | ✅ Swift 5.10 | N/A |
